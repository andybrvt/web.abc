...
export const FooterBlocks = [
  {
    ...
    content: `
      ...
      <div class = "row infoRowFooter">
        <div class ="col infoColFooter">
          ...
          <div class="firstListItem">
            ...
            <div class="firstListItem">555-555-5555</div>
            <div class="firstListItem">thisisanexample@gmail.com</div>
            <div class="firstListItem">Put the social media stuff here</div>
          </div>
