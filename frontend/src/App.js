      ...
      {account ? (
        <Routes>
          ...
          <Route
            exact
            path="/home"
            element={<NewLanding history={history} />}
          />
          <Route
            exact
            path="/createSite"
            element={<CreateSite history={history} />}
          />
          <Route
            exact
            path="/collectionList"
            element={<CollectionList history={history} />}
          />
          <Route
            exact
            path="/collection/:contract"
            element={<UploadImageNFT history={history} />}
          />
          <Route
            exact
            path="/test"
            element={<IFrameMoralisTest history={history} />}
          />
          <Route
            exact
            path="/compilerTest"
            element={<CompilerTest history={history} />}
          />
          <Route
            exact
            path="/grapesTest"
            element={<GrapesjsTest history={history} />}
          />
          <Route
            exact
            path="/build/:websiteId/:buildType"
            element={<MainBuildContainer history={history} />}
          />
          <Route
            exact
            path="/designerTest"
            element={<Canvas history={history} />}
          />
          <Route
            exact
            path="/previewPage/:websiteId/:pageId"
            element={<PreviewPage history={history} />}
          />
          <Route
            exact
            path="/webabc/:websiteId/:pageId"
            element={<OfficialPage history={history} />}
          />
          <Route
            exact
            path="/smartContract"
            element={<SmartContractCustomize history={history} />}
          />
          <Route exact path="/docs" element={<Docs history={history} />} />
          <Route
            exact
            path="/contract"
            element={<SmartContractView history={history} />}
          />
          <Route
            exact
            path="/contractDashboard"
            element={<SmartContractDash history={history} />}
          />
          <Route
            exact
            path="/websiteDashboard/:websiteId"
            element={<WebsiteDashboard history={history} />}
          />
          <Route
            exact
            path="/startCollection/:websiteId"
            element={<StartCollection history={history} />}
          />
        </Routes>
      ) : (
        <Routes>
